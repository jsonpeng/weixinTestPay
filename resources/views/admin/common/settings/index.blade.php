            ...
            <div class="box box-info form">
                ...
                <div class="box-body">
                    <form class="form-horizontal" id="form1">
                        ...
                        <div class="form-group">
                                                <label for="weixin_erweima" class="col-sm-3 control-label">微信客服二维码</label>
                                                <div class="col-sm-9">
                        ...
                        <div class="form-group">
                            <label for="weixin" class="col-sm-3 control-label">题目纠错选项</label>
                            <div class="col-sm-9">
            ...
            <div class="box box-info form">
                ...
                <div class="box-body">
                    <form class="form-horizontal" id="form8">
                        ...
                        <div class="form-group">
                            <label for="feie_sn" class="col-sm-3 control-label">接口过期时间(小时)</label>
                            <div class="col-sm-9">
                                <input type="number" class="form-control" name="token_time" value="{{ getSettingValueByKey('token_time') }}"></div>
                        </div>

                  {{--       <div class="form-group">
                            <label for="feie_sn" class="col-sm-3 control-label">接口加密密钥(至少12位)</label>
                            <div class="col-sm-9">
                                <input type="password" class="form-control" name="token_key" value="{{ getSettingValueByKey('token_key') }}"></div>
                        </div> --}}
