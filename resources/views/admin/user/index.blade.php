...
@section('content')
    <section class="content-header">
        <h1 class="pull-left">用户列表</h1><a style="margin-top: 5px;display: block;" href="javascript:$('.reportForm').submit();">全部导出</a>
...
<script type="text/javascript">
  ...
  {
    if(confirm('确定取消所有职位吗?取消后将无法恢复!'))
    {
      $.zcjyRequest('/ajax/reset_user/'+user_id,function(res){
        if(res){
          alert(res);
          location.reload();
        }
